 ...
 *
 * Compile command:
 * javac -classpath .\lib\*;C:\java\jre7\lib\* -sourcepath .\app\src\main\java\ OrmliteDatabaseConfigUtil.java
 *
 * run command:
 * java -classpath .;.\*;.\lib\*;C:\java\jre7\lib\*;.\app\src\main\java\ OrmliteDatabaseConfigUtil
 */
import java.io.File;
...
//import ru.pva33.sms_parse.database.*;
import ru.pva33.whereparking.db.*;
...
public class OrmliteDatabaseConfigUtil extends OrmLiteConfigUtil {
    ...
    private static final Class<?>[] classes = new Class[] {
            ParkingPoint.class, ParkingSide.class, ParkingRestriction.class
    };
...
//        Sms sms = new Sms();
        System.out.print("main finished successfully!");
    }
}